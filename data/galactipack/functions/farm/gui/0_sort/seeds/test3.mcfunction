...
execute store success score #temp galactipack.data run data get storage galactipack:data temp1.tag
execute store success score #temp1 galactipack.data run data get storage galactipack:data temp3.tag
