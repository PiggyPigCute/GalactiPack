...
data modify storage galactipack:itemio space_farm append value {Slot: 3b,mode: "input",allowed_side: {top: 1b},filters: [{id:["minecraft:wheat_seeds","minecraft:beetroot_seeds","minecraft:potato","minecraft:carrot"]}]}
data modify storage galactipack:itemio space_farm append value {Slot: 6b,mode: "input",allowed_side: {north: 1b,south: 1b,east: 1b,west: 1b},filters: [{id:["minecraft:water_bucket"]}]}
