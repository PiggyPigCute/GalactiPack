...
execute if score #temp2 galactipack.data matches 2 if data storage galactipack:data Items[{Slot:5b,id:"minecraft:beetroot"}] run scoreboard players set #temp2 galactipack.data 0
