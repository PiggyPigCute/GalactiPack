...
# o2 tanks
	#t1
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}],1:[{Slot:0b,id:"minecraft:air"},{Slot:1b,id:"minecraft:iron_ingot"},{Slot:2b,id:"minecraft:air"}],2:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/tank/t1
	#t2
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:1b}}}},{Slot:1b,id:"minecraft:diamond"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:1b}}}}],2:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/tank/t2
	#t3
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"red_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"red_meteor_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:2b}}}},{Slot:1b,id:"minecraft:diamond"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:2b}}}}],2:[{Slot:0b,tag:{ctc:{id:"red_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"red_meteor_plate"}}}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/tank/t3
	#t4
	##execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"..._plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:3b}}}},{Slot:1b},{Slot:2b,tag:{galactipack:{o2_tank:{tier:3b}}}}],2:[{Slot:0b,tag:{ctc:{id:"..._plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/tank/t4
	#t5
	##execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"..._plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:4b}}}},{Slot:1b},{Slot:2b,tag:{galactipack:{o2_tank:{tier:4b}}}}],2:[{Slot:0b,tag:{ctc:{id:"..._plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/tank/t5
	#t6
	##execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"..._plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:5b}}}},{Slot:1b},{Slot:2b,tag:{galactipack:{o2_tank:{tier:5b}}}}],2:[{Slot:0b,tag:{ctc:{id:"..._plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/tank/t6

# o2 machines
	#compressor
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,id:"minecraft:iron_bars"},{Slot:1b,tag:{ctc:{id:"iron_plate"}}},{Slot:2b,id:"minecraft:iron_bars"}],1:[{Slot:0b,tag:{ctc:{id:"o2_tank"}}},{Slot:1b,tag:{ctc:{id:"copper_plate"}}},{Slot:2b,tag:{ctc:{id:"o2_tank"}}}],2:[{Slot:0b,id:"minecraft:bucket"},{Slot:1b,tag:{ctc:{id:"iron_plate"}}},{Slot:2b,id:"minecraft:bucket"}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/o2/machine/compressor
	#collector
