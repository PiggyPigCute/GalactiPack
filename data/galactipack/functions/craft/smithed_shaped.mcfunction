...
# blocks
	...
	#space_farm
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_pane"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}],1:[{Slot:0b,tag:{ctc:{id:"red_meteor_plate"}}},{Slot:1b,id:"minecraft:diamond_hoe",tag:{Damage:0}},{Slot:2b,tag:{ctc:{id:"red_meteor_plate"}}}],2:[{Slot:0b,id:"minecraft:water_bucket"},{Slot:1b,id:"minecraft:farmland"},{Slot:2b,id:"minecraft:water_bucket"}]}} run function galactipack:craft/smithed_shaped/space_farm
	#meteor_shield
...
# o2 tanks
	#t1
	execute if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}],1:[{Slot:0b,id:"minecraft:air"},{Slot:1b,id:"minecraft:iron_ingot"},{Slot:2b,id:"minecraft:air"}],2:[{Slot:0b,tag:{ctc:{id:"iron_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"iron_plate"}}}]}} run loot replace block ~ ~ ~ container.16 loot galactipack:i/items/o2_tanks/t1
	#t2
	execute if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"red_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"red_meteor_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:1b}}}},{Slot:1b,id:"minecraft:diamond"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:1b}}}}],2:[{Slot:0b,tag:{ctc:{id:"red_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"red_meteor_plate"}}}]}} run function galactipack:craft/smithed_shaped/o2_tank_t2
	#t3
	execute if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"green_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"green_meteor_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:2b}}}},{Slot:1b,id:"minecraft:obsidian"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:2b}}}}],2:[{Slot:0b,tag:{ctc:{id:"green_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"green_meteor_plate"}}}]}} run function galactipack:craft/smithed_shaped/o2_tank_t3
	#t4
	execute if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"green_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"green_meteor_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:3b}}}},{Slot:1b,id:"minecraft:ancient_debris"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:3b}}}}],2:[{Slot:0b,tag:{ctc:{id:"green_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"green_meteor_plate"}}}]}} run function galactipack:craft/smithed_shaped/o2_tank_t4
	#t5
	execute if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"blue_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"blue_meteor_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:4b}}}},{Slot:1b,id:"minecraft:netherite_ingot"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:4b}}}}],2:[{Slot:0b,tag:{ctc:{id:"blue_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"blue_meteor_plate"}}}]}} run function galactipack:craft/smithed_shaped/o2_tank_t5
	#t6
	execute if entity @s[scores={smithed.data=0}] if data storage smithed.crafter:main root.temp{crafting_input:{0:[{Slot:0b,tag:{ctc:{id:"blue_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"blue_meteor_plate"}}}],1:[{Slot:0b,tag:{galactipack:{o2_tank:{tier:5b}}}},{Slot:1b,id:"minecraft:netherite_block"},{Slot:2b,tag:{galactipack:{o2_tank:{tier:5b}}}}],2:[{Slot:0b,tag:{ctc:{id:"blue_meteor_plate"}}},{Slot:1b,id:"minecraft:glass_bottle"},{Slot:2b,tag:{ctc:{id:"blue_meteor_plate"}}}]}} run function galactipack:craft/smithed_shaped/o2_tank_t6
