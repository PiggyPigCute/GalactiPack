...
data modify storage galactipack:itemio o2_compressor append value {Slot: 4b,mode: "input",allowed_side: {north: 1b,south: 1b,east: 1b,west: 1b,top: 1b},filters: [{ctc: [{from:"piggypig:galactipack",id:"o2_tank"}]}]}
