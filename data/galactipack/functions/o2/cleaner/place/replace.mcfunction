...
execute as @e[type=glow_item_frame,tag=galactipack.temp,limit=1,distance=..1] run function galactipack:o2/cleaner/place/as_frame
setblock ~ ~ ~ dropper{CustomName:'{"italic":false,"color":"black","text":"Oxygen Cleaner"}'}
