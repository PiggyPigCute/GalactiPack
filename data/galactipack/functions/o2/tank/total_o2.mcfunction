...
#o2 max
execute store result score #max galactipack.o2 run data get storage galactipack:data slot1.max
execute store result score #temp galactipack.o2 run data get storage galactipack:data slot2.max
