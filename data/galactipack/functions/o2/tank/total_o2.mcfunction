...
#o2 now
execute store result score #temp1 galactipack.o2 run data get storage galactipack:temp slot1.now
scoreboard players operation @s galactipack.o2 += #temp1 galactipack.o2
execute store result score #temp2 galactipack.o2 run data get storage galactipack:temp slot2.now
scoreboard players operation @s galactipack.o2 += #temp2 galactipack.o2

#o2 max
execute store result score #max galactipack.o2 run data get storage galactipack:temp slot1.max
