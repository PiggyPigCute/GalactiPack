...
execute if score #temp galactipack.data matches 0 if data entity @s Inventory[{tag:{galactipack:{o2_tank:{creative:true}}}}] run function galactipack:o2/tank/total_o2
