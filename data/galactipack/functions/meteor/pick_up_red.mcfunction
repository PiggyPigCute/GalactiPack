...
loot give @s loot galactipack:i/items/meteors/red_meteor_iron

# may give a sceond Red Meteoric Iron (10% chance)
execute if predicate galactipack:chance/10pc run loot give @s loot galactipack:i/items/meteors/red_meteor_iron
