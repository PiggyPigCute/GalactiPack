...
execute if score #valid_item itemio.math matches 0 if data storage itemio:main servo_items[0] run function itemio:v0.9.0/container/output/try_input_after/nbt_check
