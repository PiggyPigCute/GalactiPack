...
execute if data storage itemio:main.output ioconfig[0] run function itemio:v0.9.0/container/output/custom/output_noconfig/loop_ioconfig with storage itemio:main.output temp.args_loop_ioconfig
