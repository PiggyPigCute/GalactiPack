...
execute if score #!same_item itemio.math.output matches 0 run function itemio:v0.9.0/container/output/custom/output_noconfig/check_filters with storage itemio:main.output temp.args_check_filters
