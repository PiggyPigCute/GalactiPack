...
execute if score #filters.valid_item itemio.io matches 1 run function itemio:v0.9.0/container/output/custom/output_noconfig/check_filters with storage itemio:main.output temp.args_check_filters
