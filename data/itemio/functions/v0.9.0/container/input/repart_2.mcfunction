...
execute as @e[tag=itemio.selected.input, tag=!itemio.container.auto_handled_io, tag=!itemio.container.nope] run function itemio:v0.9.0/container/input/custom/input
execute unless entity @e[tag=itemio.selected.input, tag=!itemio.container.nope, tag=!itemio.container.auto_handled_io] run function itemio:v0.9.0/container/input/repart_vanilla
