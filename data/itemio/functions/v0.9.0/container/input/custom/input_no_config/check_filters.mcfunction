...
execute if score #filters.valid_item itemio.io matches 1 run function itemio:v0.9.0/container/input/custom/input_no_config/process_input with storage itemio:main.input temp.args
