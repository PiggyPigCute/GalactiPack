...
execute if score #!same_item itemio.math.input matches 0 run function itemio:v0.9.0/container/input/custom/input_no_config/process_input/if_item/sup/fill with storage itemio:main.input temp.args
