...
execute if score #new_count_container itemio.math.input <= #full_stack itemio.math.input run function itemio:v0.9.0/container/input/custom/input_no_config/process_input/if_item/inf/test_nbt with storage itemio:main.input temp.args
execute if score #new_count_container itemio.math.input > #full_stack itemio.math.input if score #count_container itemio.math.input < #full_stack itemio.math.input run function itemio:v0.9.0/container/input/custom/input_no_config/process_input/if_item/sup/test_nbt with storage itemio:main.input temp.args
