...
execute if score #loop_count_input itemio.math.input matches 1.. run function itemio:v0.9.0/container/input/vanilla/inf_insert/loop_items
execute in minecraft:overworld run function itemio:v0.9.0/container/input/vanilla/inf_insert/dimension
