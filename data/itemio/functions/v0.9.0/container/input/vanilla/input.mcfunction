...
execute unless score #block_size itemio.math.input matches 0 run function itemio:v0.9.0/container/input/vanilla/try_input
execute if block ~ ~ ~ chest[type=left] run function itemio:v0.9.0/container/input/vanilla/double_chest_left
execute if block ~ ~ ~ trapped_chest[type=left] run function itemio:v0.9.0/container/input/vanilla/double_chest_left
execute if block ~ ~ ~ chest[type=right] run function itemio:v0.9.0/container/input/vanilla/double_chest_right
execute if block ~ ~ ~ trapped_chest[type=right] run function itemio:v0.9.0/container/input/vanilla/double_chest_right
