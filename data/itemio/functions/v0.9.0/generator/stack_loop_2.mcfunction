...
item modify block -30000000 23 1610 container.0 itemio:v0.9.0/internal/input/add_count
...
item modify block -30000000 22 1610 container.0 itemio:v0.9.0/internal/input/add_count
item modify block -30000000 22 1610 container.1 itemio:v0.9.0/internal/input/add_count
