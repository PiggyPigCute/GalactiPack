function itemio:v0.9.0/generator/set_storage
...
function itemio:v0.9.0/generator/stack_loop
...
function itemio:v0.9.0/generator/add_end with storage itemio:main temp
