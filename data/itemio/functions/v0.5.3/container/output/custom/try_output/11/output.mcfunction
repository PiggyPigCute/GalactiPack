...
data modify storage itemio:io output set from storage itemio:main.output Items[{Slot: 11b}]
...
execute if score #remove_count itemio.math.output matches 1.. run item modify block ~ ~ ~ container.11 itemio:v0.5.3/internal/output/remove_count
