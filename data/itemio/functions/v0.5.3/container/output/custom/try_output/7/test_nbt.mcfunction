...
data modify storage itemio:main.output Item2 set from storage itemio:main.output Items[{Slot: 7b}]
...
execute if score #!same_item itemio.math.output matches 0 run function itemio:v0.5.3/container/output/custom/try_output/7/test_filters_ioconfig
