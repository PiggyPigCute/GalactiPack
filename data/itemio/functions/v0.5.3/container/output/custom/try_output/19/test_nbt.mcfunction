...
data modify storage itemio:main.output Item2 set from storage itemio:main.output Items[{Slot: 19b}]
...
execute if score #!same_item itemio.math.output matches 0 run function itemio:v0.5.3/container/output/custom/try_output/19/test_filters_ioconfig
