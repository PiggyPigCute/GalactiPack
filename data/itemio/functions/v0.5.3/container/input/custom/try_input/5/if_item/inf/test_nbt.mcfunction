...
data modify storage itemio:main.input temp.Item2 set from storage itemio:main.input Items[{Slot: 5b}]
...
execute if score #!same_item itemio.math.input matches 0 run function itemio:v0.5.3/container/input/custom/try_input/5/if_item/inf/fill
