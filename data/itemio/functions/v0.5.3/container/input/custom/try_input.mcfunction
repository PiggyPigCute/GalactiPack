...
execute if score #filters.valid_item itemio.io matches 1 run function itemio:v0.5.3/container/input/custom/repart
data remove storage itemio:main.input ioconfig[0]
execute if data storage itemio:main.input ioconfig[0] run function itemio:v0.5.3/container/input/custom/try_input
